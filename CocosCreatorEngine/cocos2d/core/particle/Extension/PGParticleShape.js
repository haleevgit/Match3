...
ParticleShape.ShapeType = ShapeType;
ParticleShape.ShapeHelper = ShapeHelper;
ParticleShape.ExtendedShapeHelper = ExtendedShapeHelper;
ParticleShape.RectangleShapeHelper = RectangleShapeHelper;
ParticleShape.VectorShapeHelper = VectorShapeHelper;
ParticleShape.EdgeShapeHelper = EdgeShapeHelper;
ParticleShape.CircleShapeHelper = CircleShapeHelper;
ParticleShape.DonutShapeHelper = DonutShapeHelper;

pg.ParticleShape = module.exports = ParticleShape;
