...
const ParticleLife = cc.Class({
	...
	properties: {
		...
		delay: { default() { return new pg.ParticleValue(0, 0, 1)}, type: pg.ParticleValue, },
		lifetime: { default() { return new pg.ParticleValue(1, 0, 1)}, type: pg.ParticleValue, },
		//#endregion
...
if (CC_EDITOR) {
	ParticleLife.template = [
		...
		{ name: 'delay', type: 'object', view: pg.ParticleValue, },
		{ name: 'lifetime', type: 'object', view: pg.ParticleValue, },
	];
}


pg.ParticleLife = module.exports = ParticleLife;
