...
const DecoratorParticleTrail = ccclass('ParticleTrail')
const ParticleTrailND = class ParticleTrail extends pg.ParticleExtension {
	constructor() {
		super();
		this._result = [];
	};
...
apply(ParticleTrailND.prototype, "_isActive", [ property({}) ], {
	initializer() { return false; },
	writable: true,
	enumerable: true,
	configurable: true,
}, ParticleTrailND.prototype);
apply(ParticleTrailND.prototype, "isActive", [ property({ displayName : "Trail" }) ], {
...
apply(ParticleTrailND.prototype, "_trailType", [ property({}) ], {
	initializer() { return TrailType.None; },
	writable: true,
	enumerable: true,
	configurable: true,
}, ParticleTrailND.prototype);
apply(ParticleTrailND.prototype, "trailType", [ property({ type : TrailType, visible() { return this._isActive }, }) ], {
	get() { return this._trailType; },
	set(value) {
		if (this._trailType !== value) {
			this._trailType = value;
...
apply(ParticleTrailND.prototype, "trail", [ property({ type : TrailHelper, visible() { return this.trailType !== TrailType.None; }, }) ], {
	initializer() { return null; },
	writable: true,
	enumerable: true,
	configurable: true,
}, ParticleTrailND.prototype);
const ParticleTrail = DecoratorParticleTrail(ParticleTrailND, ParticleTrailND);
...
ParticleTrail.TrailType = TrailType;
ParticleTrail.TrailHelper = TrailHelper;
ParticleTrail.LocalPointTrailHelper = LocalPointTrailHelper;
ParticleTrail.LocalTargetTrailHelper = LocalTargetTrailHelper;
ParticleTrail.WorldPointTrailHelper = WorldPointTrailHelper;
ParticleTrail.WorldTargetTrailHelper = WorldTargetTrailHelper;

pg.ParticleTrail = module.exports = ParticleTrail;
